		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: '../ajax/buscar_verificar_socio.php?action=ajax&page=' + page + '&q=' + q,
                 ...
                 function activacion(id){
                       ...
                       // alert(id_camion)
                        ...
                        $(fila).css('background-color', 'lightblue');
                         ...
                         $.ajax({
		        url: '../ajax/buscar_activacion.php?action=ajax&page=' + page + '&id_camion=' + id_camion+ '&id_usuario=' + id_usuario,
		        beforeSend: function(objeto) {
		          $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
                ...
                function cargarDocumento(id,id_usuario){
                        //aalert();
                      
                        
                         $.ajax({
		        url: '../ajax/cargar_documento_socio.php?action=ajax&id=' + id + '&id_usuario=' + id_usuario,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
		       camion(id_usuario)                         
                ...
                function camionq(){
                        ...
                        $(fila).css('background-color', 'lightblue');
                         ...
                         $.ajax({
		        url: '../ajax/buscar_documentos_socio.php?action=ajax&page=' + page + '&q=' + q+ '&id=' + id,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
