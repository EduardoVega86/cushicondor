		...
		function load(page) {
		    ...
		    var q = $("#q").val();
                    var id=$("#id_edificio").val();
             
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: '../ajax/buscar_personal.php?action=ajax&page=' + page + '&q=' + q+'&id=' + id,
		...
		$("#guardar_personal").submit(function(event) {
                   // alert();
		    $('#guardar_datos').attr("disabled", true);
		    var parametros = $(this).serialize();
		    $.ajax({
		        type: "POST",
		        url: "../ajax/nuevo_personal.php",
		        data: parametros,
		        beforeSend: function(objeto) {
		...
		$("#editar_dep").submit(function(event) {
