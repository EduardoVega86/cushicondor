...
function reporte(){
        ...
        function stock(id){
           // alert(id)
               $('#id_producto').val(id);
                $.ajax({
		        url: '../ajax/buscar_stock_linea.php?action=ajax&id_producto=' + id,
        ...
        function agrega_st(){
           ...
           id=$('#id_producto').val()
           fecha=$('#fecha_vence_lote').val()
           stock_lote=$('#stock_lote').val()
              $.ajax({
		        url: '../ajax/buscar_stock_linea.php?action=agrega&id_producto=' + id+'&cantidad='+stock_lote+'&fecha='+fecha,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
        ...
        function eliminar_stock(id_stock){
          ...
          id=$('#id_producto').val()
              $.ajax({
		        url: '../ajax/buscar_stock_linea.php?action=elimina&id_stock=' + id_stock+'&id_producto='+id,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
