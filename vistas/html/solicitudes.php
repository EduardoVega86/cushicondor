...
get_cadena($user_id);
$modulo = "Solicitud Socio";
permisos($modulo, $cadena_permisos);
//Finaliza Control de Permisos
$title    = "Solicitud Socio";
$Usuarios = 1;
							...
							<div id="bg-primary" class="panel-collapse collapse show">
								<div class="portlet-body">
										...
										<div class="form-group row">
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" class="form-control" id="q2" placeholder="Buscar por Placa" onkeyup='camionq();'>
													<span class="input-group-btn">
														<button type="button" class="btn btn-info waves-effect waves-light" onclick='load(1);'>
															<span class="fa fa-search" ></span> Buscar</button>
														</span>
												...
												<div class="col-md-3">
													<div class="btn-group pull-right">
														<button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#nuevoCamion"><i class="fa fa-plus"></i> Nuevo</button>
													</div>
							...
							<div id="bg-primary" class="panel-collapse collapse show">
								<div class="portlet-body">
										...
										<div class='outer_div3'></div>     
                                                                                <button id="agregar_socio" onclick="activarsocio()" class="form-control btn btn-primary" disabled="">Activar Socio</button>
                            </div>
                                                            </div>
                                            </div>
                                </div></div>
