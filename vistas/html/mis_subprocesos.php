...
<?php
$id_proceso=$_GET['id'];
//echo "select * from subproceso where id_proceso=$id_proceso;";
    $query_procesos = mysqli_query($conexion, "select * from subproceso where id_proceso=$id_proceso;");
    while ($rw = mysqli_fetch_array($query_procesos)) {
        $id_proceso=$rw['id_subproceso'];
        ?>
            <div class="col-lg-6 col-xl-6">
              ...
              <div class="widget-bg-color-icon card-box">
                ...
                <div class="text-right">
                  <h5 class="text-dark text-center"><b class="counter text-success"><?php echo $rw['subproceso']; ?></b></h5>
                  <p class="text-muted mb-0"> <?php
                  $sql = "SELECT COUNT(*) as cantidad FROM actividades WHERE id_subproceso = $id_proceso";
                  $resultado = $conexion->query($sql);
                  if ($resultado) {
    $fila = $resultado->fetch_assoc();
    $cantidad_subprocesos = $fila['cantidad'];
    echo  $cantidad_subprocesos . ' ACTIVDADES';
} else {
