								...
								<form class="form-horizontal" role="form" id="datos_cotizacion">
										...
										<div class="col-md-12">
											<div class="input-group">
                                                                                            ...
                                                                                            <img width="45px" src="../../img/4149678.png" alt=""/>
													<?php
       ...
       $(document).ready( function () {
        $(".UpperCase").on("keypress", function () {
         ...
         function departamento_id(id){
            //alert(id)
               $('#id_subproceso').val(id);
                $.ajax({
		        url: '../ajax/buscar_actividad.php?action=ajax&id_producto=' + id,
        ...
        function agrega_st(){
           ...
           id=$('#id_subproceso').val()
         // alert(id)
           actividad=$('#actividad').val()
           fecha=$('#fecha_limite').val()
           //stock_lote=$('#stock_lote').val()
              $.ajax({
		        url: '../ajax/buscar_actividad.php?action=agrega&id_producto=' + id+'&actividad='+actividad+'&fecha='+fecha,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
        ...
        function eliminar_contacto(id){
          ...
          //alert(id)
          id_dep=$('#id_subproceso').val()
              $.ajax({
		        url: '../ajax/buscar_actividad.php?action=elimina&id=' + id+'&id_producto='+id_dep,
		        beforeSend: function(objeto) {
		            $('#loader').html('<img src="../../img/ajax-loader.gif"> Cargando...');
		        },
		        success: function(data) {
