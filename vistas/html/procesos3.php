										...
										<div class="form-group row">
											...
											<div class="input-group">
                                                                                            ...
                                                                                            <img width="45px" src="<?php
                                                                                                        echo get_row('proceso2', 'url_image', 'id_proceso', $id_proceso);
                                                                                                        ?>" alt=""/>
													<?php
                                                                                                        echo $id_proceso;
                                                                                                        echo '<h2>'. get_row('proceso2', 'nombre', 'id_proceso', $id_proceso).'</h2>';
                                                                                                        ?>
												</div>
											</div>
											<div class="col-md-3">
...
<script type="text/javascript" src="../../js/VentanaCentrada.js"></script>
	<script type="text/javascript" src="../../js/procesos3.js"></script>
	<script>
