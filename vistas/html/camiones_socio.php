...
<div id="wrapper">
	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
<?php if ($permisos_ver == 1 and get_row('users', 'habilitar_camion', 'id_users', $user_id)==1) {
    ?>
				<div class="col-lg-12">
					<div class="portlet">
...
?>
	...
	<!-- ============================================================== -->
	<script type="text/javascript" src="../../js/camiones_socio.js"></script>
	<script>
