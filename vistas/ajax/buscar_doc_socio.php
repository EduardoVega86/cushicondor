...
//echo $diabled;
$sql_check   = "SELECT * FROM  docuser where user_id=$user_id and docrequire_id=$id ";
    //echo $sql_check;
    ...
    <tr >
        ...
        <td style="text-align: center"><?php if($upload==1){
            ...
            <a href=" <?php echo $url;?>" target="blank"> <img width="40px" src="../../img/sistema/338851.png" alt=""/></a>
                <?php }else{?>
      <input type="file" class='form-control' name="imagefile<?php echo $id; ?>" id="imagefile<?php echo $id; ?>" onchange="upload_image(<?php echo $id; ?>,<?php echo $user_id; ?>);">
        <?php    }}
?></td>
        <td>
...
<td>
    ...
    <input onclick="cargarDocumento(<?php echo $id;?>,<?php echo $user_id;?>)"  <?php if($check > 0){ echo 'checked'; }?>  class="form-check-input" style="margin-left:10px; width: 30px; height: 30px;" type="checkbox" id="check2"></td>
   </tr>
   <?php
}
        ?>
