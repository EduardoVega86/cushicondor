...
if (empty($_POST['firstname'])) {
    ...
    $razon_social    = mysqli_real_escape_string($conexion, (strip_tags($_POST["razonsocial"], ENT_QUOTES)));
    ...
    if ($query_check_user == 1) {
        ...
        $sql = "INSERT INTO users (nombre_users, apellido_users, usuario_users, con_users, email_users, cargo_users, sucursal_users, razon_social, date_added)
        VALUES('" . $firstname . "','" . $lastname . "','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "', '" . $user_group_id . "','" . $sucursal . "','" . $razon_social . "','" . $date_added . "');";
