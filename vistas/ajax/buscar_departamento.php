...
if ($action == 'ajax') {
    ...
    $sWhere .= " order by id_departamento";
    ...
    $nume_dep+=$nume_dep+1;
           ...
           // $date_added          = date('d/m/Y', strtotime($row['date_added']));
            ...
            ?>
                    ...
                    <td><img width="45px" src="../../img/166258.png" alt=""/> <a class="" href="#" data-toggle="modal" data-target="#stock_ad" onclick="departamento_id('<?php echo $id_departamento; ?>');"> VER</a></td>
