           ...
           /* if ($status_producto == 1) {
            ...
            ?>
                ...
                <tr>
                    ...
                    <td> <form action="subir2.php" method="post" enctype="multipart/form-data">
...
if ($image_path == null) {
            ...
            ?>
                    ...
                    <td ><a href="procesos3.php?id=<?php echo $id_proceso ?>"> <img width="30px" src="../../img/4149678.png" alt=""/>GESTIONAR </a></td>
