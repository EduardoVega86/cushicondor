...
if (empty($_POST['latitud'])) {
   ...
   $referencia= mysqli_real_escape_string($conexion, (strip_tags($_POST["referencia"], ENT_QUOTES)));
        $sql              = "INSERT INTO `bodega` (`nombre`, `id_empresa`, `longitud`, `latitud`, `direccion`, `num_casa`, `referencia`, `responsable`, `contacto`, `localidad`) "
                . "VALUES ('$nombre', '$users', '$longitud', '$latitud', '$direccion', '$numero_casa', '$referencia', '$contacto', '$telefono', '$localidad');";
