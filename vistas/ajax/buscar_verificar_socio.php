...
if ($action == 'ajax') {
    ...
    $sTable   = "users";
    $sWhere   = "where cargo_users=6 and status=1";
    if ($_GET['q'] != "") {
        $sWhere = " and (";
...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    ...
                    <input type="hidden" value="<?php echo $identificacion; ?>" id="identificacion<?php echo $user_id; ?>">
                     <input type="hidden" value="<?php echo $estado_civil; ?>" id="estado_civil<?php echo $user_id; ?>">
                     <input type="hidden" value="<?php echo $genero; ?>" id="genero<?php echo $user_id; ?>">
                    <input type="hidden" value="<?php echo $telefono; ?>" id="telefono<?php echo $user_id; ?>">
                     <input type="hidden" value="<?php echo $id_vendedor; ?>" id="id_vendedor<?php echo $user_id; ?>">
                      <input type="hidden" value="<?php echo $direccion; ?>" id="direccion<?php echo $user_id; ?>">

                    <tr onclick="camion(<?php echo $user_id; ?>);activacion(<?php echo $user_id; ?>)" id="solicitud<?php echo $user_id; ?>">
