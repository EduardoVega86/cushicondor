...
if ($action == 'ajax') {
    ...
    $sTable   = "productos, stock_lote";
    $sWhere   = "where productos.id_producto=stock_lote.id_producto";
    if ($_GET['q'] != "") {
        $sWhere .= " and (";
...
if($fecha_actual < $fecha_entrada)
	...
	echo "<p>".$vence."</p>";
		...
		{
		echo "<p style='color:red'>".$vence."</p>";
		}
                                 ?> 
                        </div></td>
                        <td class='col-xs-1' width="15%">
                        <div class="pull-right">
                            <input type="text" class="form-control" style="text-align:center" id="cantidad_<?php echo $id_producto; ?>"  value="1" readonly="readonly">
                        </div>
                        </td>
                        <td class='col-xs-2' width="15%"><div class="pull-right">
                        ...
                        <td class='text-center'>
                        <a class='btn btn-success' href="#" title="Agregar a Factura" onclick="agregar('<?php echo $id_producto ?>','<?php echo $id_stock ?>')"><i class="fa fa-plus"></i>
                        </a>
                        </td>
                    </tr>
                    <?php
