...
if (isset($conexion)) {
    ?>
	<div id="editarDep" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" method="post" id="editar_dep" name="editar_dep">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" id="mod_estado" name="mod_estado" required>
										...
										<option value="1" selected>Habitado</option>
