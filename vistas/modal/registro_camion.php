...
if (isset($conexion)) {
    ?>
	<div id="nuevoCamion" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
			...
			<div class="modal-content">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname" class="control-label">Estado:</label>
                                                                        <input type="hidden"  id="usuariocamion" name="usuariocamion" >
                                                                        <select class='form-control' name='estadocamion' id='estadocamion' required>
                ...
                <div class="row"><div class="col-md-6">
								<div class="form-group">
									...
									<select class='form-control' name='vantype' id='vantype' required>
												<option value="">-- Selecciona --</option>
												<?php
...
?>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary waves-effect waves-light" id="guardar_datos_camion">Guardar</button>
					</div>
				</form>
			</div>
		</div>
