							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control UpperCase" id="nombre" name="nombre" autocomplete="off" required>
                                                    ...
                                                    <div class="col-md-6">
								<div class="form-group">
									<label for="nombre" class="control-label">Razón Social (opcional):</label>
									<input type="text" class="form-control UpperCase" id="razon_social" name="razon_social" autocomplete="off" >
								</div>
							</div>
						</div>
						<div class="row">
